...
# PROFINET UUIDs (matching C implementation - stored in BE, swapped to LE for wire)
# Per src/profinet/profinet_rpc.c:44-46
PNIO_UUID = bytes([0xDE, 0xA0, 0x00, 0x01, 0x6C, 0x97, 0x11, 0xD1,
