...
create_systemd_service() {
    ...
    log_info "Creating environment file: $env_file"
    {
        ...
        echo ""
        echo "WTC_GRAFANA_PASSWORD=${WTC_GRAFANA_PASSWORD}"
...
do_docker_install() {
    ...
    if [[ -z "${WTC_GRAFANA_PASSWORD:-}" ]]; then
        log_info "Generating secure Grafana password..."
        export WTC_GRAFANA_PASSWORD=$(generate_password 24)
    fi
    ...
    (
        ...
        export WTC_GRAFANA_PASSWORD="$WTC_GRAFANA_PASSWORD"
    ...
    log_info "  Grafana Password: $WTC_GRAFANA_PASSWORD"
    log_info "  Database Password: $WTC_DB_PASSWORD"
