        ...
        <div className="min-h-screen flex flex-col">
          ...
          <footer className="border-t border-slate-800/50 py-4 px-6">
            <div className="max-w-[1800px] mx-auto flex items-center justify-between text-xs text-slate-500">
              ...
              <span>PROFINET I/O Controller • Real-time Monitoring</span>
            </div>
          </footer>
        </div>
      </body>
...
function NavLink({
  ...
  return (
    <a
      href={href}
      className="flex items-center gap-2 px-3 py-2 rounded-lg text-sm font-medium text-slate-300 hover:text-white hover:bg-slate-800/50 transition-all"
    >
      {icon}
      {children}
    </a>
