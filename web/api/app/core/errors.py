...
OPERATOR_MESSAGES: dict[str, str] = {
    ...
    "NOT_FOUND": "The requested resource was not found. It may have been removed or does not exist.",
    "COMMUNICATION_ERROR": "Cannot communicate with the device. Check connection and try again.",
