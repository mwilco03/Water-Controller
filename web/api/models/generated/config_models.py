...
class ControllerConfig(BaseModel):
    ...
    station_name: str = Field(default="", max_length=63, pattern=r"^$|^[a-z0-9][a-z0-9-]{0,62}$", description="Controller station name (auto-generated as 'controller-XXXX' from MAC if empty)")
...
class ProfinetConfig(BaseModel):
    ...
    interface: str = Field(default="", max_length=32, pattern=r"^$|^[a-zA-Z0-9_-]+$", description="Network interface for PROFINET communication (auto-detect if empty)")
