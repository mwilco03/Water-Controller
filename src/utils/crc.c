/*
 * Water Treatment Controller - CRC Utilities Implementation
 * Copyright (C) 2024
...
bool crc32_verify_fcs(const uint8_t *frame, size_t len) {
    ...
    /* Calculate CRC over entire frame including FCS */
    uint32_t crc = crc32_update(0xFFFFFFFF, frame, len);

    /* Valid frame will result in magic value */
